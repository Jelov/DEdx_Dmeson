...
HiJetAlgosPlugins_LOC_FLAGS_CXXFLAGS   := -DCGAL_DISABLE_ROUNDING_MATH_CHECK -Wno-unknown-pragmas
HiJetAlgosPlugins_LOC_FLAGS_REM_CXXFLAGS   := -Werror=unused-variable
HiJetAlgosPlugins_LOC_USE := self  FWCore/Framework FWCore/PluginManager RecoJets/JetProducers FWCore/ParameterSet RecoHI/HiJetAlgos DataFormats/JetReco CondFormats/DataRecord CondCore/DBOutputService CondCore/PopCon JetMETCorrections/Objects Geometry/CaloGeometry cgal f77compiler
...
RecoHIHiJetAlgos_LOC_USE := self  boost FWCore/Framework RecoJets/JetProducers DataFormats/HeavyIonEvent
...
RecoJetsJetProducers_LOC_USE := self  boost FWCore/Framework DataFormats/JetReco DataFormats/PatCandidates Geometry/CaloGeometry Geometry/CaloTopology Geometry/Records Geometry/CommonDetUnit SimDataFormats/CaloHit RecoJets/JetAlgorithms DataFormats/CastorReco CommonTools/Utils fastjet roottmva vdt_headers boost_serialization CondFormats/DataRecord
