...
ALL_TOOLS      += blackhat
blackhat_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/blackhat/0.9.9-eccfad/include
...
ALL_TOOLS      += boost
boost_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/boost/1.57.0-eccfad/include
...
boost_header_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/boost/1.57.0-eccfad/include
...
boost_python_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/boost/1.57.0-eccfad/include
...
cascade_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/cascade/2.2.04-eccfad2/include
...
ALL_TOOLS      += cgal
cgal_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/cgal/4.2-eccfad/include
...
ALL_TOOLS      += charybdis
charybdis_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/charybdis/1.003-eccfad2/include
charybdis_EX_LIB := charybdis
charybdis_EX_USE := root_cxxdefaults f77compiler herwig pythia6

ALL_TOOLS      += classlib
classlib_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/classlib/3.1.3-eccfad/include
...
ALL_TOOLS      += clhep
clhep_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/clhep/2.1.4.1-eccfad/include
clhep_EX_LIB := CLHEP
clhep_EX_USE := root_cxxdefaults

ALL_TOOLS      += clhepheader
clhepheader_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/clhep/2.1.4.1-eccfad/include
clhepheader_EX_USE := root_cxxdefaults

ALL_TOOLS      += cmssw
ALL_SCRAM_PROJECTS += cmssw
cmssw_EX_LIBDIR := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/cms/cmssw/CMSSW_7_5_8/lib/slc6_amd64_gcc491
cmssw_EX_USE := root_cxxdefaults
cmssw_ORDER := 96000

ALL_TOOLS      += cmsswdata
cmsswdata_EX_FLAGS_CMSSW_DATA_PACKAGE  := CalibCalorimetry/CaloMiscalibTools=V01-00-00 CalibTracker/SiPixelESProducers=V02-00-00 Calibration/Tools=V01-00-00 CondFormats/JetMETObjects=V01-00-03 Configuration/Generator=V01-00-00 DQM/PhysicsHWW=V01-00-00 DetectorDescription/Schema=V02-02-01 FastSimulation/MaterialEffects=V04-02-08 Fireworks/Geometry=V07-05-00 GeneratorInterface/EvtGenInterface=V01-00-00 GeneratorInterface/ReggeGribovPartonMCInterface=V00-00-02 HLTrigger/JetMET=V01-00-00 L1Trigger/L1TCalorimeter=V01-00-05 L1Trigger/RPCTrigger=V00-15-00 MagneticField/Interpolation=V01-00-00 RecoBTag/SecondaryVertex=V02-00-00 RecoBTag/SoftLepton=V01-00-01 RecoEgamma/ElectronIdentification=V01-00-06 RecoEgamma/PhotonIdentification=V01-00-03 RecoHI/HiJetAlgos=V01-00-01 RecoJets/JetProducers=V05-10-14 RecoLocalCalo/EcalDeadChannelRecoveryAlgos=V01-00-00 RecoMET/METPUSubtraction=V01-00-03 RecoMuon/MuonIdentification=V01-12-01 RecoParticleFlow/PFBlockProducer=V02-04-02 RecoParticleFlow/PFProducer=V15-00-00 RecoParticleFlow/PFTracking=V13-01-00 SimG4CMS/Calo=V03-00-00 SimG4CMS/Forward=V02-03-18 Validation/Geometry=V00-07-00

ALL_TOOLS      += coral
ALL_SCRAM_PROJECTS += coral
coral_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/cms/coral/CORAL_2_3_21-eccfad9/include/LCG
...
ALL_TOOLS      += curl
curl_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/curl/7.28.0-eccfad/include
curl_EX_LIB := curl
...
ALL_TOOLS      += dcap
dcap_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/dcap/2.47.8-eccfad/include
dcap_EX_LIB := dcap
...
ALL_TOOLS      += evtgen
evtgen_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/evtgen/1.3.0-eccfad4/include
evtgen_EX_LIB := EvtGen EvtGenExternal
evtgen_EX_USE := hepmc pythia8 tauolapp photospp

ALL_TOOLS      += evtgenlhc
evtgenlhc_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/evtgenlhc/9.1-eccfad
...
frontier_client_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/frontier_client/2.8.11-eccfad/include
...
geant4core_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/geant4/10.00.p03-eccfad2/include/Geant4
...
geant4core_EX_FLAGS_CXXFLAGS  := -DG4MULTITHREADED -ftls-model=global-dynamic -pthread
...
geant4static_EX_FLAGS_CXXFLAGS  := -DG4MULTITHREADED -ftls-model=global-dynamic -pthread
...
ALL_TOOLS      += gmp
gmp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/gmp-static/5.1.3-eccfad/include
gmp_EX_LIB := gmp
gmp_EX_USE := mpfr
...
ALL_TOOLS      += hector
hector_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/hector/1.3.4-eccfad7/include
...
hepmc_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/hepmc/2.06.07-eccfad/include
...
ALL_TOOLS      += herwig
herwig_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/herwig/6.521-eccfad2/include
herwig_EX_LIB := herwig herwig_dummy
herwig_EX_USE := root_cxxdefaults f77compiler lhapdf photos

ALL_TOOLS      += herwigpp
herwigpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/herwigpp/2.7.1-eccfad2/include
...
jimmy_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/jimmy/4.2-eccfad2/include
jimmy_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += ktjet
ktjet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/ktjet/1.06-eccfad/include
...
ALL_TOOLS      += lhapdf
lhapdf_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/lhapdf/6.1.5-eccfad2/include
...
ALL_TOOLS      += libpng
libpng_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/libpng/1.6.16-eccfad/include
libpng_EX_LIB := png
...
ALL_TOOLS      += libxslt
libxslt_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/libxslt/1.1.26/include/libxslt
libxslt_EX_LIB := xslt
...
ALL_TOOLS      += llvm
llvm_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/llvm/3.6-eccfad/include
llvm_EX_LIB := clang
...
ALL_TOOLS      += mctester
mctester_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/mctester/1.25.0a-eccfad7/include
...
ALL_TOOLS      += mpfr
mpfr_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/mpfr-static/3.1.2-eccfad/include
mpfr_EX_LIB := mpfr
...
ALL_TOOLS      += photospp
photospp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/photospp/3.56-eccfad/include
...
ALL_TOOLS      += pythia8
pythia8_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/pythia8/212/include
...
ALL_TOOLS      += python
python_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/python/2.7.6-eccfad/include/python2.7
...
ALL_TOOLS      += rivet
rivet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/rivet/2.2.1-eccfad2/include
rivet_EX_LIB := Rivet
...
roofitcore_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/lcg/root/6.02.12/include
...
root_interface_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/lcg/root/6.02.12/include
root_interface_EX_USE := root_cxxdefaults

ALL_TOOLS      += rootcling
rootcling_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/lcg/root/6.02.12/include
...
ALL_TOOLS      += self
self_EX_INCLUDE := /afs/cern.ch/work/c/chengchi/work/2016RunPre/Data_check/Dmeson_dedx/CMSSW_7_5_8_patch3/src /afs/cern.ch/work/c/chengchi/work/2016RunPre/Data_check/Dmeson_dedx/CMSSW_7_5_8_patch3/include/LCG /cvmfs/cms.cern.ch/slc6_amd64_gcc491/cms/cmssw-patch/CMSSW_7_5_8_patch3/src /cvmfs/cms.cern.ch/slc6_amd64_gcc491/cms/cmssw-patch/CMSSW_7_5_8_patch3/include/LCG
self_EX_LIBDIR := /afs/cern.ch/work/c/chengchi/work/2016RunPre/Data_check/Dmeson_dedx/CMSSW_7_5_8_patch3/lib/slc6_amd64_gcc491 /afs/cern.ch/work/c/chengchi/work/2016RunPre/Data_check/Dmeson_dedx/CMSSW_7_5_8_patch3/external/slc6_amd64_gcc491/lib /cvmfs/cms.cern.ch/slc6_amd64_gcc491/cms/cmssw-patch/CMSSW_7_5_8_patch3/lib/slc6_amd64_gcc491 /cvmfs/cms.cern.ch/slc6_amd64_gcc491/cms/cmssw-patch/CMSSW_7_5_8_patch3/external/slc6_amd64_gcc491/lib
...
ALL_TOOLS      += sherpa
sherpa_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/sherpa/2.1.1-eccfad2/include/SHERPA-MC
sherpa_EX_LIB := SherpaMain ToolsMath ToolsOrg
sherpa_EX_USE := root_cxxdefaults hepmc lhapdf qd blackhat fastjet sqlite

ALL_TOOLS      += sigcpp
sigcpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/sigcpp/2.2.10-eccfad/include/sigc++-2.0
...
ALL_TOOLS      += tauolapp
tauolapp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/tauolapp/1.1.5-eccfad4/include
...
ALL_TOOLS      += tbb
tbb_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/tbb/43_20150316oss/include
tbb_EX_LIB := tbb
...
ALL_TOOLS      += thepeg
thepeg_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/thepeg/1.9.2p1-eccfad2/include
...
ALL_TOOLS      += valgrind
valgrind_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/valgrind/3.10.1-eccfad/include
...
vdt_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/cms/vdt/v0.3.2-eccfad/include
...
ALL_TOOLS      += xrootd
xrootd_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/xrootd/4.0.4-eccfad3/include/xrootd /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/xrootd/4.0.4-eccfad3/include/xrootd/private
xrootd_EX_LIB := XrdUtils XrdClient
xrootd_EX_USE := root_cxxdefaults

ALL_TOOLS      += xz
xz_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/xz/5.2.1/include
xz_EX_LIB := lzma
xz_EX_USE := root_cxxdefaults

ALL_TOOLS      += yaml-cpp
yaml-cpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/yaml-cpp/0.5.1-eccfad/include
yaml-cpp_EX_LIB := yaml-cpp
yaml-cpp_EX_USE := boost

ALL_TOOLS      += yoda
yoda_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc491/external/yoda/1.3.1-eccfad/include
yoda_EX_LIB := YODA
yoda_EX_USE := boost
